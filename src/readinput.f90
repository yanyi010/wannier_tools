...
!===============================================================================================================!
   ...
   if (cpuid==0) then
      ...
      write(stdout, '(1x, a, i6   )')'N_Floquet : ', N_Floquet
      write(stdout, '(1x, a, i6   )')'Nt : ', Nt
      write(stdout, '(1x, a, f16.5, a)')'Floquet_omega : ', Floquet_omega
      write(stdout, '(1x, a, f16.5, a)')'A0 : ', A0_x, A0_y, A0_z
   endif
   ...
   Floquet_omega = Floquet_omega * eV2Hartree ! for floquet.f90
